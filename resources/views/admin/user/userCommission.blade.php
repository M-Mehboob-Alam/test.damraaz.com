                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="theme-form theme-form-2 mega-form"
                                        action="{{ route('admin.user.add.commission') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ $user->id }}">
                                        <div class="row">
                                            <div class="mb-4 row align-items-center">
                                                <label class="form-label-title col-sm-4 mb-0">Commission
                                                    Amount</label>
                                                <div class="col-sm-6">
                        ...
                        <table class="table all-package theme-table" id="table_id">
                            ...
                            <tbody>
                                @foreach ($commission as $com)
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModalCommission{{ $com->id }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="theme-form theme-form-2 mega-form"
                                                        action="{{ route('admin.user.change.commission') }}"
                                                        method="POST">
                                                        @csrf
