                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('admin.product.store') }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-4 row align-items-center">
                                        <label class="form-label-title col-sm-3 mb-0">Product Name <span
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        <label class="col-sm-3 col-form-label form-label-title">Category <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single w-100" required name="category">
                                    ...
                                    <div class="mb-4 row">
                                        <label class="form-label-title col-sm-3 mb-0">Images <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="file" class="form-control" required accept="image/*" multiple
                                                name="images[]">
                                            <div class="form-text">Upload multiple images</div>
                                        </div>
                                    </div>
                                    <div class="mb-4 row align-items-center">
                                        <label class="col-sm-3 form-label-title">price <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        <label class="col-sm-3 form-label-title">Discount price <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input class="form-control" name="discount_price" required type="number"
                                                placeholder="80">
                                        </div>
                                    </div>

                                    <div class="mb-4 row align-items-center">
                                        <label class="col-sm-3 form-label-title">Delivery Days <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input class="form-control" name="delivery_days" required type="number"
                                                placeholder="3">
                                        </div>
                                    </div>
                                    <div class="mb-4 row align-items-center">
                                        <label class="col-sm-3 form-label-title">Delivery Charges<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input class="form-control" name="delivery_charges" required type="number"
                                                placeholder="10">
                                        </div>
                                    </div>
                                    <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="deal" type="text"
                                                placeholder="Enter Your deal name for week">
                                            <div class="form-text">for week</div>
                                        </div>
                                    </div>
                                    <div class="mb-4 row">
                                        <label class="form-label-title col-sm-3 mb-0">Info <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="mb-4 row">
                                        <label class="form-label-title col-sm-3 mb-0">Detail <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
