...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2>Return Detail</h2>
            <div class="col-md-6 my-1 h5 ">  Name: {{$returnOrder->name??''}}        </div>
            <div class="col-md-6 my-1 h5 ">  Whatsapp: {{$returnOrder->whatsapp??''}}        </div>
            <div class="col-md-6 my-1 h5 ">  Status: {{$returnOrder->status??''}}        </div>
            <div class="col-md-6 my-1 h5 ">  Message: {{$returnOrder->message??''}}        </div>
            <div class="col-12 h4">Reson: {{$returnOrder->reason}}</div>
            @foreach(json_decode($returnOrder->images) as $image)
