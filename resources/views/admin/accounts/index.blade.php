...
@section('content')
    <div class="container-fluid">
        <div id="page_content" style="background-color: white; border-radius:10px; padding:2rem">
            ...
            <form action="{{route('admin.store_accounts')}}" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn btn-sm btn-primary mt-2" href="{{ route('admin.account_toggle', $acc->id) }}">
                    @if($acc->status == 1)
                        Deactiavte
                    @else
                        Activate
                ...
                @elseif($acc->account_type == 'JaazCash')
