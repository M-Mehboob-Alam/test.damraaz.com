        ...
        <div class="container-fluid-lg">
           ...
           @endif
            ...
            @if(session('cart'))
                ...
                $delivery_charges += $details['shop_charges']
                  @endphp
                    @foreach ($details['products'] as $key => $item)
                        @php
                ...
                @php
                       ...
                       $profit = $total + $profit + $delivery_charges;
                @endphp
            @endif
            <div class="tab-content" id="nav-tabContent">
                ...
                @php
                    ...
                    $cod = PaymentGateway::where('method', 'COD')->where('isHide', true)->first();
                    $advancePayment = PaymentGateway::where('method', 'AdvancePayment')->where('isHide', true)->first();
                    $wallet = PaymentGateway::where('method', 'Wallet')->where('isHide', true)->first();
                @endphp
                ...
                <div class="col-12 my-2">
                    ...
                    <select name="payment_method" required id="payment_method" class="form-control">
                        ...
                        @if (count(session('cart')) == 1)
                            @if (array_key_exists('58',session()->get('cart')))
                                @if (blank($cod))
                                <option value="cod">Cash On Delivery</option>
                                @endif
                                @if (blank($advancePayment))
                ...
                <div class="row g-sm-4 g-3 my-2" id="account-details-form" >
                    <h1 class="text-danger">In-Case COD (Cash On Delivery) You must pay delivery charges </h1>
                    <div class="col-12 my-2">
