                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header theme-bg-color text-white">
                                        <div class="py-0 my-0 d-flex justify-content-between">
                                            ...
                                            @if ($inProgress->status != 'cancelled' &&( $inProgress->status == 'processing'|| $inProgress->status == 'pending'))
                                                <a class="btn text-white " data-bs-toggle="modal"
                                                    title="Cancel Order"
                                                    data-bs-target="#cancel_order{{ $inProgress->order_id }}"><b>Cancel
                                                        Item</b></a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="StepProgress border-bottom my-2">
                                            <div class="StepProgress-item "><strong>Supplier</strong>
                                                ...
                                                {{-- <span>Province: <b>{{ $shop->shop->province }}</b></span>
                                                <span>City: <b>{{ $shop->shop->city }}</b></span>
                                                <span>Address: <b>{{ $shop->shop->address }}</b></span> --}}
                                            </div>
