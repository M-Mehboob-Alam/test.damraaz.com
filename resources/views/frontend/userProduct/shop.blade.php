                ...
                <div class="col-12">
                    <div class="breadscrumb-contain">
                        ...
                        @auth
                            ...
                            @endphp
                            <br>
                            @if (!blank($firstProduct) && $firstProduct->user_id)
                                @php
                                    $follower = App\Models\Follower::where('shop_id', $firstProduct->user_id)
                                        ->where('user_id', Auth()->id())
                                        ->where('active', true)
                                        ->first();
                                @endphp
                                <a title="{{ $follower ? 'Unfollow' : 'Follow' }} Shop" class="mx-md-2 mx-1"
                                    href="{{ route('shop.follow', $firstProduct->user_id) }}">{{ $follower ? 'Following' : 'Follow' }}
                                    Shop</a>
                            @else
                                @php
                                    $follow = App\Models\Follower::where('shop_id', 1)
                                        ...
                                        ->first();
                                @endphp
                                <a class="mx-md-2 mx-1" title="{{ $follow ? 'Unfollow' : 'Followe' }} Shop"
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item ">Shop Product </li>
                                <li class="breadcrumb-item active">
                                    {{ Auth()->user()->business ?? env('APP_NAME') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="search-box">
                        <form method="get" class="input-group">
                            <input type="text" name="name" value="{{ request()->name }}" class="form-control"
                                placeholder="Search by name" aria-label="Example text with button addon">
                            <input type="number" name="min_price" value="{{ request()->min_price }}" class="form-control"
                                placeholder="min price" aria-label="Example text with button addon">
                            <input type="number" name="max_price" value="{{ request()->max_price }}" class="form-control"
                                placeholder="max price" aria-label="Example text with button addon">
                            <select class="form-control" name="sort" aria-label="Default select example">
                                <option selected disabled>Sort By</option>
                                <option value="lowToHigh" {{ request()->sort == 'lowToHigh' ? 'selected' : '' }}>Low To High
                                </option>
                                <option value="highToLow" {{ request()->sort == 'highToLow' ? 'selected' : '' }}>High To Low
                                </option>
                            </select>
