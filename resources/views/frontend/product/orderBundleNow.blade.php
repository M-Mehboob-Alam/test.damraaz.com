                ...
                <div class="row">
                    <div class="col-12 col-sm-8 col-md-8 py-5 my-3 container shadow rounded">
                        <div class="row">
                            ...
                            @endforeach
                           @endif
                            <form action="{{ route('orderNowProductBundleDetail') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <h3 class="text-danger">Pay Delivery Charges Rs.{{$bundles->product_bundle->delivery_charges}} & Upload The Slip </h3>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" name="phone" min="11" class="form-control" required id="">
