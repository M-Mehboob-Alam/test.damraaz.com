            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                    <div class="row g-8">
                            ...
                            <div class="product-box-4">
                                <div class="product-image">
                                    <div class="label-flex">
                                        <a href="{{route('add.to.wishlist',$top->product->id)}}" class="btn p-0 wishlist btn-wishlist notifi-wishlist">
                                        ...
                                        @endphp 
                                    <a href="{{route('product.show',$top->product->id)}}">
                                        <img src="{{asset($image[0])}}" class="img-fluid" alt="">
                                    </a>

                                    <ul class="option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Quick View">
                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#viewDetail{{$top->product->id}}">
                                                <i class="iconly-Show icli"></i>
                                            </a>
                                        </li>
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Buy Now">
                                                <form action="{{ route('add.to.cart', $top->product->id) }}">
                                ...
                                <div class="product-detail">
                                    ...
                                    <!--</ul>-->
                                    <a href="{{route('product.show',$top->product->id)}}">
                                        <h5 class="name">{{$top->product->name?? ''}}</h5>
                                    </a>
                                    <h5 class="price theme-color">Rs. {{$top->product->discount_price?? ''}}<del>Rs. {{$top->product->price??""}}</del></h5>
                                    <!--<div class="price-qty">-->
                                    ...
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--            {{--<!--data-bs-toggle="modal" data-bs-target="#addToCart{{$top->product->id}}"-->--}}-->
                                    <!--    <a href="{{route('add.to.cart',$top->product->id)}}"  class="buy-button buy-button-2 btn btn-cart">-->
                                    <!--        <i class="iconly-Buy icli text-white m-0"></i>-->
                                    <!--    </a>-->
                                    <!--</div>-->
                                    <form method="get" class="price-qty" action="{{route('add.to.cart',$top->product->id)}}">
                                        <div class="counter-number">
                                            <div class="counter">
                                                <div class="qty-left-minus" data-type="minus" data-field="">
                                                    <i class="fa-solid fa-minus"></i>
                                                ...
                                                <div  data-href="{{route('product.show',$top->product->id)}}" class="qty-right-plus product_item" data-type="plus" data-field="">
                        ...
                        <div class="modal fade theme-modal view-modal "  id="viewDetail{{$top->product->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                                        ...
                                        <div class="row g-sm-4 g-2">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="right-sidebar-modal">
                                                    ...
                                                    <h4 class="price">Rs. {{$top->product->discount_price??''}}  <del>Rs. {{$top->product->price??''}}</del></h4>
                                                    ...
                                                    <div class="modal-button">
                                                        <button onclick="location.href = '{{ route('add.to.cart', $top->product->id) }}';"
                                                            class="btn btn-md add-cart-button icon">Add
                                                            To Cart</button>
                                                        <button onclick="location.href = '{{route('product.show',$top->product->id)}}';"
                        ...
                        <!-- Quick View Modal Box End -->
                         ...
                         <!-- add to cart -->
                        <div class="modal fade theme-modal view-modal "  id="addToCart{{$top->product->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-sm-4 g-2">
                                            <form method="get" action="{{route('add.to.cart',$top->product->id)}}">
                                                  <div class="mb-3">
