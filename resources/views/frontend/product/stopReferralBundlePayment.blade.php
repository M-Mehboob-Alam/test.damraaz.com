@extends('layouts.app')
@section('title')
   Stop Referral Earning Payments
@endsection
            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-12 col-sm-8 col-md-8 shadow rounded">
                        <div class="row">
                            <h3 class="text-danger">Fill Out Correctly Payment & Form Now </h3>
                            <hr>
                            @if ($errors->any())
                            ...
                            @endforeach
                           @endif
                            <form action="{{ route('stoppedReferralEarningPayment') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <h3 class="text-danger">Pay Rs.2500 & Upload The Slip </h3>
