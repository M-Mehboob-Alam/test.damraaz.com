                          ...
                          <div class="heading-box">
                            <div class="title-box4">
                              <h2 class="heading text-center">
                                ...
                                All Products 
                                @endif
                                <span class="bg-theme-blue"></span></h2>
                              ...
                              <div>
                                  <div class="product-card">
                                    <div class="img-box">
                                      ...
                                      <a href="{{route('product.show',$product->slug)}}" class="primary-img"><img class="img-fluid bg-img" src="{{asset($product->image)}}" alt="product" /> </a>
                                    ...
                                    <div class="content-box">
                                      <a href="{{route('product.show',$product->slug)}}">
                                        ...
                                        <h5>{{$product->name}}
                                             ...
                                             <span class="badge badge-danger text-danger">Mega Sales</span>
                                             @endif
                                        </h5>
