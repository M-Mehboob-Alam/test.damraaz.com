                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form class="theme-form theme-form-2 mega-form" action="{{route('user.product.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4 row">
                                    <label class="form-label-title col-sm-3 mb-0">Product Thumbnail <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control" required accept="image/x-png,image/gif,image/jpeg"  name="image">
                                        <div class="form-text">Product Thumbnail</div>
                                    </div>
                                </div>
                                @if ($shop->isAllowedMegaSale)

                                <div class="mb-4 row">
                                    <label class="form-label-title col-sm-3 mb-0">Mega Sale ? <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="form-check">

                                            <input class="form-check-input" type="radio" name="isAllowedMegaSale" value="1" id="flexRadioDefault1">
                                            <label class="form-check-label" for="flexRadioDefault1">
                                              Yes
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="radio" name="isAllowedMegaSale" value="0" id="flexRadioDefault2" checked>
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="name" required class="form-control" type="text" placeholder="Product Name">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control" required accept="image/x-png,image/gif,image/jpeg" multiple name="images[]">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required name="price" type="number" placeholder="100">
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">quantity <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" required name="quantity" type="number" placeholder="100">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="discount_price" required type="number" placeholder="80">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="delivery_days" required type="number" placeholder="3">
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">Delivery Charges<span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" name="delivery_charges" required type="number" placeholder="10">
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">Offer Name </label>
                                    <div class="col-sm-9">
                                        <input class="form-control" name="offer" type="text" placeholder="Enter Your offer name(optional)">
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 form-label-title">Deal Name </label>
                                    <div class="col-sm-9">
                                        <input class="form-control" name="deal" type="text" placeholder="Enter Your deal name for week(optional)">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" required name="info" rows="2" placeholder="Info about product"></textarea>
                                    </div>
                                </div>
                                <div class="mb-4 row">
                                    <label class="form-label-title col-sm-3 mb-0">Detail <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="detail" required placeholder="Description about product" rows="3"></textarea>
                                    </div>
                                </div>
