...
@section('content')
    <section class="contact-box-section">
        <div class="container-fluid-lg">
            ...
            <p>Welcome to Damraaz!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Damraaz's Website, located at
                https://damraaz.com/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Damraaz if
                you
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                ...
                Company's stated services, in accordance with and subject to, prevailing law of pk. Any use of the above
            ...
            <p>We employ the use of cookies. By accessing Damraaz, you agreed to use cookies in agreement with the Damraaz's
                Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Damraaz and/or its licensors own the intellectual property rights for all material
                on
                Damraaz. All intellectual property rights are reserved. You may access this from Damraaz for your own
                personal
                use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Damraaz</li>
                <li>Sell, rent or sub-license material from Damraaz</li>
                <li>Reproduce, duplicate or copy material from Damraaz</li>
                <li>Redistribute content from Damraaz</li>
            </ul>



            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                areas of the website. Damraaz does not filter, edit, publish or review Comments prior to their presence on
                the
                website. Comments do not reflect the views and opinions of Damraaz,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
                applicable laws, Damraaz shall not be liable for the Comments or for any liability, damages or expenses
                caused
                and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
                website.
            </p>

            <p>Damraaz reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Damraaz a non-exclusive license to use, reproduce, edit and authorize others to use,
                reproduce
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                you
                must inform us by sending an e-mail to Damraaz. Please include your name, your organization name, contact
            ...
            <p>No use of Damraaz's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
