...
@section('content')
    ...
    <section class="breadscrumb-section pt-0 d-none">
            ...
            <div class="row">
                ...
                <div class="col-xxl-3 col-lg-3">
                    <div class="dashboard-left-sidebar">
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('user.withdraw.create') }}" class="nav-link"aria-selected="false"><i
                            ...
                            <li class="nav-item d-lg-block d-none" role="presentation">
                                <button class="nav-link" onclick=location.href="{{ route('order.inProgress') }}"><i
                                        data-feather="shopping-bag"></i>Order</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            <li class="nav-item dropdown">
                                <a class="nav-link2 dropdown-toggle" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <i data-feather="shopping-bag"></i> Products
                                </a>
                                <ul class="dropdown-menu w-100 p-1">
                                    <li>
                                        <button class="dropdown-item nav-link fs-6 p-1" id="pills-product-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-product" type="button"
                                            role="tab" aria-controls="pills-product" aria-selected="false">Your
                                            Products</button>
                                    </li><br>
                                    <li><button class="dropdown-item fs-6  nav-link  p-1"
                                            onclick=location.href="{{ route('user.product.create') }}">Add Product</button>
                                    </li>
                ...
                <div class="col-xxl-9 col-lg-9">
                    <div class="row g-2 rounded theme-bg-color text-white">
                        ...
                        <div class="col-4 py-1">
                            <p class="text-center">{{ $myPaidProfits->sum('amount') + $myPendingProfits->sum('amount') }}
                            </p>
                                                ...
                                                <tbody>
                                                    @forelse($products as $product)
                                                        <tr>
                                                            ...
                                                            <td class="product-image"><img src="{{ asset($image[0]) }}"
                                                                    class="img-fluid"></td>
                                            ...
                                            <div class="ms-auto">
                                                <h6 class="mb-1">Referral Link</h6>
                                                    <div class="input-group mb-3">
                                                        <input id="referralLink" type="text" value="{{route('referralRegister',$user->username??'')}}"  class="form-control" readonly aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                        <button class="input-group-text" id="copyLink"><i class="fa fa-copy"></i></button>
                                                      </div>

                                            </div>
                                            {{-- <div class="ms-auto">
                                                <h6 class="mb-1">Completed Orders</h6>
                                                <div class="ms-auto p-4 fs-3 rounded-circle theme-bg-color text-white">
                                                    {{ $countCompletedOrders <= 10 ? $countCompletedOrders : 10 }}/10</div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="d-flex mt-3">
                                                    <h5><a href="{{ route('user.product.shop', $user->id) }}"
                                                            title="Visit Your Shop">{{ $user->business ?? '-' }}</a></h5>
                                            ...
                                            <li>
                                                <h5>Total Commission :</h5>
                                                <h5 class="badge theme-bg-color text-white">Rs. {{ $amount }}</h5>
                                            </li>
                                            <li>
                                                <h5>Total Withdraw :</h5>
                                                <h5 class="badge theme-bg-color text-white">Rs.
                                                    {{ $withdraws->sum('amount') }}</h5>
                                            </li>
                                            <li>
                                                <h5>Current Balance :</h5>
                                                <h5 class="badge theme-bg-color text-white">Rs.
                                                    {{ $amount - $withdraws->sum('amount') }}
                                                </h5>
                                            </li>
                                            <li>
                                                <h5>Email :</h5>
    ...
    <div class="modal fade theme-modal" id="edit-business" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">{{ $user->business ? 'Edit' : 'Create' }} Shop</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
