        ...
        <tbody>
            <tr>
                <td>
                    <table class="header-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr class="header"
                            ...
                            <td class="header-logo" style="padding: 10px 32px;">
                                <a href="{{route('/')}}" style="display: block; text-align: left;">
                                    {{-- <img src="{{$message->embed(asset('assets/images/logo/3.png'))}}" class="main-logo" alt="Damraaz"> --}}
                                    Damraaz
                                </a>
                            </td>
                            <td class="header-menu" style="display: block; padding: 10px 32px;text-align: right;">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('frontend.contactUs.create')}}">Contact</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                    ...
                    {{-- <table class="contant-table" style="margin-bottom: -6px;" align="center" border="0"
                    ...
                    <table class="contant-table" style="margin-top: 40px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                ...
                                <td>
                                    <h4>Your account has been blocked. If you believe this is an error, please contact our support team.</h4>
                    ...
                    <table class="contant-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        width="100%">
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <p
                                        ...
                                        If you have any question, please email us at <span
                                            class="theme-color">account@damraaz.com</span> or vixit our <span
                        ...
                        <tr>
                            <td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{route('frontend.contactUs.create')}}"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td>
                                            ...
                                            <h5
                                                style="font-size: 13px; text-transform: uppercase; margin: 10px 0 0; color:#ddd; letter-spacing:1px; font-weight: 500;">
                                                {{date('Y')}} copy right by {{env('APP_NAME')}}</h5>
                                        </td>
                                    </tr>
                                </table>
                            </td>
